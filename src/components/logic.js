...
// зашифровка
function oneInput(letter, rotor) {
...
// расшифровка
function oneInputReverse(letter, rotor) {
...
// вводим слово
export function wordInput(word, rotor) {
  setRotor(rotor)
  const arr = word.split('')
  const result = []
  for (let i = 0; i < arr.length; i += 1) {
    result.push(oneInput(arr[i], rotor))
  }
  return result.join('')
}

export function wordInputReverse(word, rotor) {
  setRotor(rotor)
  const arr = word.split('')
  const result = []
  for (let i = 0; i < arr.length; i += 1) {
    result.push(oneInputReverse(arr[i], rotor))
  }
  return result.join('')
}
